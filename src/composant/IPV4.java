...
public class IPV4 {
	...
	public IPV4(Trame trame) {
		 ...
		 if(trame.trameValide()){
			 ...
			 ipSource.append(Integer.parseInt(octets.get(26),16)).append(".").append(Integer.parseInt(octets.get(27),16));
			 ipSource.append(".").append(Integer.parseInt(octets.get(28),16)).append(".").append(Integer.parseInt(octets.get(29),16));
			 ipDest.append(Integer.parseInt(octets.get(30),16)).append(".").append(Integer.parseInt(octets.get(31),16));
			 ipDest.append(".").append(Integer.parseInt(octets.get(32),16)).append(".").append(Integer.parseInt(octets.get(33),16));
	...
	public String toString() {
		...
		if (!trame.trameValide()) {
			return "IPV4 : Trame invalide";
		}
		
		if(!(octets.get(12)+octets.get(13)).equals("0800")) {
			return "Trame n'est pas de type IPV4";
		}
		...
		sb.append("\n\tFragment Offset: "+Integer.parseInt(octets.get(21),16) );
		...
		sb.append("\n\tHeader Checksum: 0x"+octets.get(24)+octets.get(25));
